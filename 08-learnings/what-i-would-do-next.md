...
- Creating a more search-led site structure
...
The objective would be to build authority around areas that matter commercially instead of spreading content across too many unrelated topics.
...
- Improving conversion paths on high-traffic landing pages
- Consolidating overlapping content

This would make SEO decision-making more systematic.
...
- CTR opportunities
- Position versus click performance
- New queries entering visibility
- Declining pages
- Search demand by topic
- High-impression pages with low traffic

The objective would be to turn Search Console into an opportunity-detection system rather than a reporting tool.
...
- Pages close to stronger ranking positions

The decision for each page could be:

**Keep → Improve → Expand → Merge → Remove**

This would keep the site healthier as the content footprint grows.
...
- Organic CAC
- Long-term value of high-performing pages

This would make SEO easier to compare with other growth channels.
